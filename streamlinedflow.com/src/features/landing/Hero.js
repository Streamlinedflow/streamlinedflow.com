    ...
    <AnimatedSection delay={0.4} type="fadeUp">
      <>
        ...
        <div className="hidden md:block text-left">
          ...
          {/* Logo + “Streamline” */}
          <div className="flex items-center mb-4 md:ml-48">
            <Image
              src="/logo.svg"
              alt="SL Flow Logo"
              width={24}
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mt-4 ml-32 relative z-20">
            ...
            <div className="mt-6 lg:mt-0 max-w-xl lg:ml-40 text-left">
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6">
                Unlock your business potential with custom AI solutions designed
                to automate your workflows and drive efficiency.
              </p>
              <Link
                href="/services"
                className="inline-block rounded-lg bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900 px-6 py-3 shadow transition-all duration-300 ease-in-out text-lg font-semibold hover:shadow-[0_0_25px_rgba(56,182,255,0.6)]"
