  ...
  return (
    <AnimatedSection delay={0.3} type="fadeUp">
      ...
      <div className="relative bg-gradient-to-r from-[#38b6ff] to-[#0080ff] py-32">
        ...
        <p className="mt-6 text-lg md:text-xl opacity-90 text-center text-white px-2">
        ...
        <div className="absolute inset-x-0 bottom-0 translate-y-1/2">
          <blockquote className="mx-auto max-w-3xl bg-white dark:bg-zinc-900 sm:rounded-3xl shadow-lg py-8 px-12 italic text-gray-700 dark:text-gray-300">
