                  ...
                  <div className="space-y-12">
                    <div className="flex items-start space-x-6 min-h-[200px]">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300">The agency was struggling with time-consuming manual processes, from gathering data across multiple sources to creating individual client reports. Their team was bogged down by repetitive tasks and faced challenges maintaining consistency across their reporting.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-6 min-h-[200px]">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300">Their team was spending countless hours each week on manual reporting tasks. This not only affected their operational efficiency but also delayed valuable insights for clients, impacting overall satisfaction and growth potential.</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="space-y-12">
                      <div className="flex items-start space-x-6 min-h-[200px]">
                        ...
                        <div>
                          ...
                          <p className="text-gray-300">We looked at the current system and figured out the key pieces of data needed for the report.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-6 min-h-[200px]">
                        ...
                        <div>
                          ...
                          <p className="text-gray-300">We set up automated reports that are created and sent to their clients on a set schedule, removing the need to do it manually.</p>
                        </div>
                      </div>
                    </div>
                  </div>
