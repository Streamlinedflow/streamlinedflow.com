  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: 'var(--color-background)' }}>
      ...
      <div className="relative z-10">
        ...
        {/* Hero Section */}
        <AnimatedSection delay={0.4} type="fadeUp" className="relative overflow-hidden">
        ...
        {/* Services Section */}
        <AnimatedSection delay={0.1} type="scaleUp" scrollTriggered={true}>
        ...
        <AnimatedSection delay={0.1} type="fadeUp" scrollTriggered={true}>
        ...
        {/* Footer */}
        <AnimatedSection delay={0.1} type="fadeIn" scrollTriggered={true}>
