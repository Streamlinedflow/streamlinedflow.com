...
const Services = () => {
  return (
    <AnimatedSection delay={0.2} type="scaleUp" scrollTriggered={true}>
      <section id="services" className="container mx-auto py-16 px-4 bg-slate-100 dark:bg-transparent relative">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Link href="/services?service=autonomous-agent" className="block">
                <div className="rounded-xl backdrop-blur-lg border-2 border-transparent bg-slate-100 dark:bg-gray-900/50 bg-clip-padding p-6 cursor-pointer transition-transform duration-300 transform hover:scale-105 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-400/20 group h-full flex flex-col">
